...
export const erpSuppliers = mysqlTable("erp_suppliers", {
	...
	uniqueIndex("uq_erp_suppliers_tenant_public").on(table.clientId, table.publicId),
	uniqueIndex("uq_erp_suppliers_tenant_tax_id").on(table.clientId, table.taxId),
	index("idx_erp_suppliers_tenant_legal_name").on(table.clientId, table.legalName),
	index("idx_erp_suppliers_tenant_active").on(table.clientId, table.active),
	index("idx_erp_suppliers_tenant_city_state").on(table.clientId, table.city, table.state),
]);
