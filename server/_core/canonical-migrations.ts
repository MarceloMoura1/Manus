...
export const REQUIRED_RUNTIME_MAIN_TABLES = [
  ...
  "erp_product_attribute_types", "erp_product_attribute_values",
  "erp_product_variants", "erp_product_variant_attribute_values",
  "erp_inventory_items", "erp_inventory_item_balances",
  "erp_product_suppliers", "erp_product_audit_logs",
...
export const REQUIRED_RUNTIME_COLUMNS: Record<string, readonly string[]> = {
  ...
  erp_product_attribute_types: ["id", "public_id", "client_id", "name", "slug", "active"],
  erp_product_attribute_values: ["id", "public_id", "client_id", "attribute_type_id", "name", "slug", "active"],
  erp_product_variants: ["id", "public_id", "client_id", "product_id", "sku", "active"],
  erp_product_variant_attribute_values: ["id", "client_id", "variant_id", "attribute_type_id", "attribute_value_id"],
  erp_inventory_items: ["id", "public_id", "client_id", "product_id", "variant_id", "kind", "active", "minimum_stock"],
  erp_inventory_item_balances: ["client_id", "inventory_item_id", "quantity", "version"],
  erp_product_suppliers: ["id", "public_id", "client_id", "product_id", "supplier_id", "is_preferred", "active"],
  erp_product_audit_logs: ["id", "public_id", "client_id", "product_id", "entity_type", "entity_public_id", "action", "actor_user_id", "summary", "created_at"],
  ...
  erp_purchase_orders: ["public_id", "client_id", "order_number", "supplier_id", "status", "subtotal_cents", "total_cents"],
