/**
 * WhatsApp Routes - Evolution API Integration
 * Endpoints que chamam o Evolution API para gerar QR Code real do WhatsApp
 */
  ...
  app.get("/api/whatsapp/qrcode", async (req, res) => {
    try {
      ...
      try {
        ...
        console.log(`[WhatsApp Routes] Instância criada:`, createResponse.data);

        const instanceId = createResponse.data?.instance?.instanceId || createResponse.data?.instanceId;
        const token = createResponse.data?.instance?.token || createResponse.data?.token;
